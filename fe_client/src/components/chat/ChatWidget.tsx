...
import { findOrCreateConversationApi, getMessagesApi, findOrCreateGuestConversationApi } from '../../api/chatApi';
    ...
    return (
        <div className="chat-widget-window">
            <div className="chat-widget-header">
                ...
                <button title='Đóng chat' onClick={toggleChat}><X size={20} /></button>
            </div>
            <div className="chat-widget-body">
                {isLoading ? (
                    ...
                    messages.map((msg, index) => {
                        const isSentByMe = (user && user.id === msg.senderId) || (guestId && guestId === msg.guestId);
                        return (
            ...
            <div className="chat-widget-footer">
                ...
                />
                <button title='Gửi tin nhắn' onClick={handleSendMessage}><Send size={20} /></button>
            </div>
        </div>
    );
};